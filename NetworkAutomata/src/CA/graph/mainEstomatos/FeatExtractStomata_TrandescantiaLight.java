 ...
 */
public class FeatExtractStomata_TrandescantiaLight extends Thread {

    private static final String outpath = "ResultadosRedesEstomatos/LightConditions/arffst";
    private static final String path = "RedesDB/DatasetEstomatos/LightConditions/validation/";
    private final String rulesDB[];

    public FeatExtractStomata_TrandescantiaLight(String _rulesDB[]) {
        rulesDB = _rulesDB;
    }
...
//
        ...
        FeatExtractStomata_TrandescantiaLight thread1 = new FeatExtractStomata_TrandescantiaLight(rules1);
        FeatExtractStomata_TrandescantiaLight thread2 = new FeatExtractStomata_TrandescantiaLight(rules2);
        FeatExtractStomata_TrandescantiaLight thread3 = new FeatExtractStomata_TrandescantiaLight(rules3);
        FeatExtractStomata_TrandescantiaLight thread4 = new FeatExtractStomata_TrandescantiaLight(rules4);
        FeatExtractStomata_TrandescantiaLight thread5 = new FeatExtractStomata_TrandescantiaLight(rules5);
        FeatExtractStomata_TrandescantiaLight thread6 = new FeatExtractStomata_TrandescantiaLight(rules6);
        FeatExtractStomata_TrandescantiaLight thread7 = new FeatExtractStomata_TrandescantiaLight(rules7);
        FeatExtractStomata_TrandescantiaLight thread8 = new FeatExtractStomata_TrandescantiaLight(rules8);
//        FeatExtractStomata_TrandescantiaLight thread9 = new FeatExtractStomata_TrandescantiaLight(rules9);
//        FeatExtractStomata_TrandescantiaLight thread10 = new FeatExtractStomata_TrandescantiaLight(rules10);
        thread1.start();
        thread2.start();
        thread3.start();
        thread4.start();
...
//=============================================
//        FeatExtractStomata_TrandescantiaLight.extractClassicalFeatures();
...
//            JWekaClassifier.runClassification(JWekaClassifier.NAIVEBAYES, arffFiles[i], directory + "/__" + arffName + "_NB.csv");
    ...
    public static void extractProposedFeatures(String rule) {
        ...
        String networkClasses[] = {"natural", "4horas", "24horas"};
        String networkAcronClasses[] = {"NAT", "L4", "L24"};
        int T = 350;
        ...
        for (int i = 0; i < networkClasses.length; i++) {
            ...
            for (int f = 0; f < fileName.length; f++) {
                ...
                for (int Threshold = 50; Threshold <= 200; Threshold = Threshold + 10) {
                    //for (int Threshold = 140; Threshold <= 140; Threshold = Threshold + 30) {
...
//        removingFile(arffFile4);//removing arffFile
    ...
    public static void extractClassicalFeatures() {
        ...
        String file = "ResultadosRedesEstomatos/LightConditions/classicalarffs/feats";
        //Feature.saveMatlabFile(featuresSamples, file + "_classic.mat");
        Feature.saveArffFile(featuresSamples, (file + "_classicsteps10ruleselection.arff"), "classical");
