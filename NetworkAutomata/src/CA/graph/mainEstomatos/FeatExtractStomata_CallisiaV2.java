 ...
 */
public class FeatExtractStomata_CallisiaV2 extends Thread {

    private static final String outpath = "ResultadosRedesEstomatos/HumidityConditions/arffs/";
    private static final String path = "RedesDB/DatasetEstomatos/HumidityConditions (albicans)/";
    ...
    public FeatExtractStomata_CallisiaV2(String _rulesDB[]) {
        rulesDB = _rulesDB;
    }

        public static void main(String[] args) throws Exception {
//
        String rules1[] = {"B014-S04567",
"B016-S023458",
"B0238-S04567",
"B034-S012456",
"B5678-S01256",
...
"B3567-S0256"};
        ...
        FeatExtractStomata_CallisiaV2 thread1 = new FeatExtractStomata_CallisiaV2(rules1); 
        thread1.start(); 
...
//
        ...
        FeatExtractStomata_CallisiaV2 thread1 = new FeatExtractStomata_CallisiaV2(rules1);
        FeatExtractStomata_CallisiaV2 thread2 = new FeatExtractStomata_CallisiaV2(rules2);
        FeatExtractStomata_CallisiaV2 thread3 = new FeatExtractStomata_CallisiaV2(rules3);
        FeatExtractStomata_CallisiaV2 thread4 = new FeatExtractStomata_CallisiaV2(rules4);
        FeatExtractStomata_CallisiaV2 thread5 = new FeatExtractStomata_CallisiaV2(rules5);
        FeatExtractStomata_CallisiaV2 thread6 = new FeatExtractStomata_CallisiaV2(rules6);
        FeatExtractStomata_CallisiaV2 thread7 = new FeatExtractStomata_CallisiaV2(rules7);
        FeatExtractStomata_CallisiaV2 thread8 = new FeatExtractStomata_CallisiaV2(rules8);
        thread1.start();
        thread2.start();
        thread3.start();
        thread4.start();
...
//        removingFile(arffFile4);//removing arffFile
    ...
    public static void extractClassicalFeatures() {
        ...
        String arrfFile = "ResultadosRedesEstomatos/HumidityConditions/classicalarffs/feats_classic.arff";
